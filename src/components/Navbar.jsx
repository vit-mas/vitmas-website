  ...
  return (
    <nav className="fixed top-8 left-0 right-0 z-50 px-8 flex justify-between items-center pointer-events-none">
      ...
      <div className="pointer-events-auto">
        <Link to="/" className="flex items-center justify-center w-20 h-20 rounded-full border border-white/20 bg-black overflow-hidden relative transition-transform hover:scale-105">
          {/* Simplified SVG approximation of the logo */}
